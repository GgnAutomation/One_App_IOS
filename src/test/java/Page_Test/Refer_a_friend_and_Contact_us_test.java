...
public class Refer_a_friend_and_Contact_us_test extends Base_Utility {
	...
	@Test(priority = 0)
	public void TC054_Refer_a_friend() throws InterruptedException {
...
//		login.login();
	...
	@Test(priority = 1)
	public void TC055_Verify_Select_State() {
	...
	@Test(priority = 2)
	public void TC056_Verify_Select_City() {
	...
	@Test(priority = 3)
	public void TC057_Verify_Select_Model() {
	...
	@Test(priority = 4)
	public void TC058_Verify_Refer_yourself() throws InterruptedException {
		Thread.sleep(10000);
		Custom_click(ob.side_menu_button(), "Side menu button");
		try {
			Custom_click(ob.refer_friend(), ob.refer_friend().getText());
		...
		if (enveronment.equalsIgnoreCase("prod")) {
			...
			mobileno = config_getdata("Stage_mobileno");
		}
	...
	@Test(priority = 5)
	public void TC059_Verify_Facebook_in_Contact_us_page() throws InterruptedException {
		Thread.sleep(10000);
		Custom_click(ob.side_menu_button(), "Side menu button");
		Thread.sleep(2000);
		try {
	...
	@Test(priority = 6)
	public void TC060_Verify_instagram_in_Contact_us_page() throws InterruptedException {
		try {
			ob.instagram();
		} catch (Exception e) {
	...
	@Test(priority = 7)
	public void TC061_Verify_Whatsapp_in_Contact_us_page() {
		try {
			ob.Whatsapp();
		} catch (Exception e) {
			try {
	...
	@Test(priority = 8)
	public void TC062_Verify_youTube_in_Contact_us_page() throws InterruptedException {
		try {
			ob.youTube();
		} catch (Exception e) {
	...
	@Test(priority = 9)
	public void TC063_Verify_Linkedin_in_Contact_us_page() throws InterruptedException {
		try {
			ob.Linkedin();
		} catch (Exception e) {
	...
	@Test(priority = 10)
	public void TC064_Verify_twitter_in_Contact_us_page() throws InterruptedException {
		try {
			ob.twitter();
		} catch (Exception e) {
	...
	@Test(priority = 11)
	public void TC065_Verify_Contact_via_Email() throws InterruptedException {
		...
		if (device.equalsIgnoreCase("emulator")) {
			try {
				...
				Message("Contact via email has already open");
			}
			Thread.sleep(2000);
